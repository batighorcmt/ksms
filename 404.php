...
<head>
    ...
    <title>পৃষ্ঠা পাওয়া যায়নি - কিন্ডার গার্ডেন স্কুল</title>
...
<body>
    ...
    <div class="error-container">
        ...
        <div class="mt-4">
            <p class="text-muted">আপনি কি কিছু খুঁজছেন? আমাদের <a href="<?php echo BASE_URL; ?>contact.php" class="text-decoration-none">সহায়তা কেন্দ্র</a> এ যোগাযোগ করুন</p>
        </div>
    </div>
    ...
    <script>
        // Automatically redirect to home page after 30 seconds
        setTimeout(function() {
